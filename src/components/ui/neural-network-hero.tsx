...
// NOTE: SplitText is a premium plugin. Replacing with standard text fade-in for this demo 
// unless user has a license key configured.
// For now, I will simulate the effect with basic GSAP to avoid breaking the build.
...
export default function Hero({
    ...
    useGSAP(
        () => {
            ...
            // Note: Replaced SplitText logic with standard GSAP fade/slide 
            // since SplitText is premium.
